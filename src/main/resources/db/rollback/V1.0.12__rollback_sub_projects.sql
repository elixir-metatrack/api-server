-- Manual rollback for V1.0.12__add_sub_projects.sql
--
...
--     < src/main/resources/db/rollback/V1.0.12__rollback_sub_projects.sql
--
-- After running this, also remove the corresponding row from
-- flyway_schema_history so Flyway doesn't think V1.0.12 is still applied:
